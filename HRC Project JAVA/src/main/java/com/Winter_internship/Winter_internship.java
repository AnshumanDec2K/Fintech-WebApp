...
public class Winter_internship {
    ...
    public String toString() {
        return "Winter_internship [sl_no=" + sl_no + ", business_code=" + business_code
                + ", cust_number=" + cust_number + ", clear_date=" + clear_date + ", business_year=" + business_year
                ...
                + document_type + ", posting_id=" + posting_id + ", total_open_amount=" + total_open_amount
                + ", baseline_create_date=" + baseline_create_date + ", cust_payment_terms=" + cust_payment_terms
                + ", invoice_id=" + invoice_id + ", isOpen=" + isOpen + ", aging_bucket=" + aging_bucket
